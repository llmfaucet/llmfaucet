/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env preview --strict-vars` (hash: 16558d3487303906159c4f28ab7fd50f)
// Runtime types generated with workerd@1.20260426.1 2026-08-23 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QuotaLimiter";
	}
	interface Env {
		BUDGETS: KVNamespace;
		DB: D1Database;
		...
		ENVIRONMENT: "preview";
		PUBLIC_WEB_ORIGINS: "https://llmfaucet-preview.dev,https://llmfaucet.pages.dev";
		NODE_ENV: string;
		...
		CF_API_TOKEN: string;
		CATALOG_KV_KEY: string;
		HEALTH_KV_KEY: string;
		...
		ANONYMOUS_DAILY_LIMIT: string;
		REGISTERED_DAILY_LIMIT: string;
		SUPPORTER_DAILY_LIMIT: string;
		PRO_DAILY_LIMIT: string;
		PUBLIC_BASE_URL: string;
		QUOTA_LIMITER: DurableObjectNamespace<import("./src/index").QuotaLimiter>;
	}
}
